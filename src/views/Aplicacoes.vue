  ...
  <div class="mb-4 row col-12">
    <div class="col-4 mb-4">
      <a href="http://192.168.26.90/ambulatorios" target="_blank">
        <v-card class="mx-auto" height="90" :image="ambulatorioImg" max-width="200" theme="light"
          title="Ambulatório"></v-card>
      </a>
    </div>

    <div class="col-4 mb-4" v-if="construcao()">
      <router-link to="/baixa-produto">
        <v-card class="mx-auto" height="90" :image="baixaProdutoImg" max-width="200" theme="light"
          title="Baixa produto"></v-card>
      </router-link>
    </div>

    <div class="col-4 mb-4">
      <router-link to="/ferramentas-lean">
        <v-card class="mx-auto" height="90" :image="ferramentasleanImg" max-width="200" theme="light"
          title="Ferramentas Lean"></v-card>
      </router-link>
    </div>

    <div class="col-4 mb-4">
      <a href="http://192.168.26.90/producao/consulta" target="_blank">
        <v-card class="mx-auto" height="90" :image="gerenciamentoImg" max-width="200" theme="light"
          title="Gerenciamento">
        </v-card>
      </a>
    </div>
    ...
    <div class="col-4 mb-4">
      <a href="http://192.168.26.90/pense&aja/" target="_blank">
        <v-card class="mx-auto" height="90" :image="penseajaImg" max-width="200" theme="light"
          title="Pense & Aja"></v-card>
      </a>
    </div>

    <div class="col-4 mb-4">
      <a href="http://192.168.26.90/producao" target="_blank">
        <v-card class="mx-auto" height="90" :image="previsaoImg" max-width="200" theme="light"
          title="Previsão"></v-card>
      </a>
    </div>

    <div class="col-4 mb-4" v-if="permissaoDP()">
      <router-link to="/departamento-pessoal">
        <v-card class="mx-auto" :image="provisorioImg" height="90" max-width="200" theme="light"
          title="Departamento Pessoal"></v-card>
      </router-link>
    </div>
    ...
    <div class="col-4 mb-4">
      <router-link to="/refeitorio">
        <v-card class="mx-auto" :image="refeitorioImg" height="90" max-width="200" theme="light"
          title="Refeitório"></v-card>
      </router-link>
    </div>

    <div class="col-4 mb-4">
      <a href="http://10.100.1.43:3000" target="_blank"><v-card class="mx-auto" height="90" :image="seasonImg"
          max-width="200" theme="light" title="Season"></v-card>
      </a>
    </div>
    ...
    <div class="col-4 mb-4" v-if="permissaoTemposMetodos()">
      <router-link to="/tempos&metodos">
        <v-card class="mx-auto" :image="temposMetodosImg" height="90" max-width="200" theme="light"
          title="T & M"></v-card>
      </router-link>
    </div>
  </div>
  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          title: 'MANUTENÇÃO', acessos: [
            { nome: 'Ranking auditoria TPM', link: 'https://lookerstudio.google.com/u/0/reporting/3d8859fe-53d5-4cd4-98dc-4d29377e3139/page/4gejD' },
          ]
        },
        ...
        {
          title: 'PERFORMANCE', acessos: [
            { nome: 'Auditoria LEAN - Ferramentais', link: 'https://lookerstudio.google.com/reporting/b465f22e-9569-4e85-99ab-a5bcc1dca5c6' },
            { nome: 'Indicador T.O.', link: 'https://lookerstudio.google.com/reporting/caeabf1a-8a2e-4e6b-ae42-9bf2248644d1' },
            { nome: 'Liderança de resultados', link: 'https://lookerstudio.google.com/reporting/f34bb26f-7df2-4127-aaab-e50a00a40750/page/p_7fxt39f06c' },
        ...
        {
          title: 'PPCP', acessos: [
            { nome: 'Indicadores PPCP', link: 'https://lookerstudio.google.com/u/0/reporting/974b81eb-1174-48f7-a5e8-8cfc5173ab5e/page/p_dif0e9czed' },
          ]
        },

        {
          title: 'PRODUÇÃO', acessos: [
            { nome: '5\'s', link: 'https://lookerstudio.google.com/reporting/a87626e4-243a-48bc-acb9-0fcac256a603' },
            { nome: 'Eficiência - Estratégica', link: 'https://lookerstudio.google.com/reporting/6d7bb8d9-56c1-4eb9-a35f-7e0c3e506fde' },
            { nome: 'Eficiência - Tática', link: 'https://lookerstudio.google.com/reporting/a58e74de-ec69-460e-94a8-1c910465b946' },
            { nome: 'Produção hora a hora', link: 'https://lookerstudio.google.com/reporting/455bddc0-7914-42b2-b8c0-287aa179571a/page/p_pv3d1xa3dd' },
          ]
        },

        {
          title: 'QUÍMICO', acessos: [
            { nome: 'Resíduo', link: 'https://lookerstudio.google.com/reporting/904f6c5d-9411-4d60-98a5-e6b1dd564466' },
          ]
        },

        {
          title: 'QUALIDADE', acessos: [
            { nome: 'Análise Checklist', link: 'https://bi.grupodass.com.br/#/site/Operacoes/views/AnlisedeChecklist_17164841004280/Checklist?:iid=1' },
            { nome: 'Análise DI', link: 'https://bi.grupodass.com.br/#/site/Operacoes/views/AnliseDI02/DI?:iid=1' },
            { nome: 'Análise Retrabalho', link: 'https://bi.grupodass.com.br/#/site/Operacoes/views/AnliseRetrabalho_17164841998980/RetrabalhosRFT?:iid=2' },
            { nome: 'Inbound Inspection Calçados', link: 'https://bi.grupodass.com.br/#/site/Operacoes/views/InboundInspection/InboundCalados?:iid=1' },
            { nome: 'Relatório parada de setor', link: 'https://lookerstudio.google.com/s/su_j9U6BKFE' },
            { nome: 'KPIs Qualidade | Devolução', link: 'https://lookerstudio.google.com/reporting/7e8d7fe2-48f9-4a0c-9f43-95ee8463f7a3' },
            { nome: 'Revisão Centro de Distribuição', link: 'https://lookerstudio.google.com/reporting/6f8dfa79-1de8-4cb7-88c2-741778269744' },
...

        {
          title: 'SSMA', acessos: [
            ...
            { nome: 'Caixas Vermelhas', link: 'https://lookerstudio.google.com/reporting/64c63708-b5eb-4752-94fc-22f9587b6502/page/by2CD' },
            { nome: 'Restrições médicas', link: 'https://lookerstudio.google.com/reporting/48535d51-9408-4426-a8d9-50400f28e15e' },
          ]
        },

        {
          title: 'TABLEAU', acessos: [
            ...
            { nome: 'Semanas em aberto', link: 'https://bi.grupodass.com.br/#/site/Operacoes/views/SemanaemAberto/SemanaemAberto_1?:iid=1' },
          ]
        },

        {
          title: 'TRF', acessos: [
            { nome: 'Curva do ramp up', link: 'https://lookerstudio.google.com/reporting/16949610-37cb-4e6f-b717-772d83bed7ee/page/oJIhD/edit' },
          ]
        },

        {
          title: 'TV DASH', acessos: [
