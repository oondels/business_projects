        ...
        <div class="col-12 row p-0 m-0">
            <div class="col-6 row m-0 mb-2 p-0 py-2 card rounded">
                ...
                <div class="col-12 px-2">
                    <div class="rounded bg-gradient-info">
                        <h5 class="text-center m-0 p-0">Compensação</h5>
                        <reports-bar-chart v-if="mostrarParcial" :id="'compensacaoComercial'"
                            :chart="compensacaoComercial" />
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        buscaPesquisaParcial() {
            axios
                .get(`http://${ip}:3050/buscaPesquisaParcial`)
                .then((response) => {
        ...
        buscaPesquisaTotal() {
            axios
                .get(`http://${ip}:3050/buscaPesquisaTotal`)
                .then((response) => {
        ...
        buscaTotaiasVotacao() {
            axios
                .get(`http://${ip}:3050/buscaTotaisVotacao`)
                .then((response) => {
        ...
        buscaDadosGerais() {
            axios
                .get(`http://${ip}:3050/buscaDadosGerais`)
                .then((response) => {
        ...
        buscaQuantidadeVotos() {
            axios
                .get(`http://${ip}:3050/buscaQuantidadeVotos`)
                .then((response) => {
