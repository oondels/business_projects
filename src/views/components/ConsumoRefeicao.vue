<template>
  <div class="row mt-15">
    <div class="col-xl-4 col-sm-12 mb-xl-0">
      <mini-statistics-card
        ...
        :value="reservasDoDia.length"
        :consumido="reservasConsumidas.length"
        :icon="{
    ...
    <div class="col-xl-4 col-sm-6 mb-xl-0">
      <mini-statistics-card
        title="Light"
        :value="reservasLight.length"
        :consumido="reservasLightConsumidas.length"
        :icon="{
    ...
    <div class="col-xl-4 col-sm-6 mb-xl-0">
      <mini-statistics-card
        title="Lanche"
        :value="reservasLanche.length"
        :consumido="reservasLancheConsumidas.length"
        :icon="{
  ...
  <div class="row position-sticky fixed-bottom bg-white border-top">
    <v-row
      no-gutters
      class="border d-flex justify-center align-center"
    ...
    >
      <v-col cols="12" :sm="5">
        <v-text-field
          ...
          v-model="codigoRfid"
          ref="codigoRfidField"
          @keypress.enter="entregaReservaPeloRfid()"
          label="Código do crachá"
        ></v-text-field>
      </v-col>
      OU
      <v-col
        class="d-flex justify-between align-center ma-2 pa-2"
        cols="12"
        sm="6"
      >
        <v-text-field
          ...
          ref="matriculaField"
          @keypress.enter="entregaReservaPelaMatricula()"
        >
        </v-text-field>
      </v-col>
      <v-btn
        ...
        text="Confirmar"
        variant="flat"
        @click="entregaReservaPelaMatricula()"
      ></v-btn>
    </v-row>
  </div>
    ...
    return {
      ...
      codigoRfidRules: [
        this.reservaEncontrada ||
          "Reserva não encontrada, tente com a matrícula",
      ],
