    ...
    <v-dialog max-width="900">
        <template v-slot:activator="{ props: activatorProps }">
            <div v-bind="activatorProps" class="col-lg-4 col-md-6 col-sm-6 mt-lg-0 mt-4 cursor-pointer">
                <mini-statistics-card :title="{ text: 'Cadastro de modelo' }" :icon="{
                    name: 'library_add',
                    color: 'text-white',
                    background: 'dark',
                }" />
            ...
            <v-card class="z-4">
                ...
                <v-card-item>
                    ...
                    <div class="col-12 row mb-2">
                        ...
                        <div class="col-4">
                            <v-select :items="processoCadastroModelo" label="Processo"
                                v-model="modelo.processo"></v-select>
                        </div>
                        <div class="col-4">
                    ...
                    <div v-for="(produto, index) in produtos" :key="index" class="col-12 row mb-2">
                        ...
                        <div class="col-4">
                            <v-text-field type="number" label="Consumo prévio"
                                v-model="produto.consumoPrevio"></v-text-field>
                        </div>
                        <div class="col-4">
                            <v-text-field type="number" label="Preço por KG" v-model="produto.precoKg"></v-text-field>
                        </div>
                        <div class="col-4">
                            <v-select :items="baseCadastroModelo" label="Base do produto"
                                v-model="produto.base"></v-select>
                        </div>
                        <div class="col-4">
                            <v-text-field type="number" label="Quantidade de recipientes"
                                v-model="produto.recipientes"></v-text-field>
                        </div>
                    </div>
