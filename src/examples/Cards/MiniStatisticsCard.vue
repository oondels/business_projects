  ...
  <div class="mb-4 card">
    <div class="p-3 card-body">
      <div class="d-flex" :class="directionReverse ? reverseDirection : ''">
        <div>
          <div class="text-center shadow icon icon-shape border-radius-md"
            :class="typeof icon === 'object' ? icon.background : ''">

            <i class="material-icons opacity-10" :class="icon.color" aria-hidden="true">{{ icon.component }}</i>
        ...
        <div :class="classContent">
          <div class="numbers">
            ...
            <h5 class="mb-0 font-weight-bolder" :class="value.color">
              ...
              <span v-if="consumido" class="text-sm font-weight-bolder text-success">
                / {{ consumido }} Consumido 
              </span>
            </h5>
          </div>
