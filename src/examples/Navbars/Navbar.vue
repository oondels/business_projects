      ...
      >
        <ul class="navbar-nav justify-content-end">
          <li class="form-check form-switch px-3 nav-item d-flex align-items-center">
            <input
              class="nav-link lh-1 p-0 form-check-input mt-1 ms-auto"
              type="checkbox"
            ...
            <template v-slot:default="{ isActive }">
              <v-card class="p-3" v-if="verificaLogin()">
                <v-card-title class="bg-danger d-flex rounded text-white text-center text-bold">
                  ...
                  <v-spacer></v-spacer>
                  <i class="material-icons cursor-pointer align-content-center m-0" @click="isActive.value = false">cancel</i>
                </v-card-title>
                        ...
                        <template v-slot:default="modalRecuperar">
                          <v-card class="container">
                            ...
                            <form class="text-start mt-3 container" @submit.prevent="recuperar">
                              ...
                              <div class="mb-3">
                                <v-text-field variant="outlined" type="password" label="Nova senha" v-model="novaSenha" />
                              </div>
                              ...
                              <div class="text-center">
                                ...
                                <material-button
                                  type="button"
                                  @click="modalRecuperar.isActive.value = false"
                                  class="my-4 mb-2"
                                  variant="gradient"
                                  color="danger"
                                  fullWidth
